...
if __name__ == "__main__":
    ...
    # Default
    with open(__file__[0:-3] + "_default.html", "w") as f:
        f.write(str(doc))

    # Indent
    with open(__file__[0:-3] + "_indent.html", "w") as f:
        f.write(doc.serialize(indent=True))

    # Indent with custom space
    with open(__file__[0:-3] + "_indent_space.html", "w") as f:
        f.write(doc.serialize(indent=True, space="    "))

    # Remove unnecessary whitespace
    with open(__file__[0:-3] + "_strip.html", "w") as f:
